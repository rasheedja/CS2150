...
public class Lab3 extends GraphicsLab
{
    ...
    protected void initScene()
    {
        ...
        {   drawUnitCube(Colour.RED,Colour.RED,Colour.RED,Colour.RED,Colour.GREEN,Colour.GREEN);
            ...
            drawUnitRoof(Colour.YELLOW, Colour.YELLOW, Colour.YELLOW, Colour.YELLOW, Colour.YELLOW);
        }
        GL11.glEndList();
    }
    ...
    private void drawUnitRoof(Colour near, Colour far, Colour left, Colour right, Colour bottom)
    {

...
public class Lab2 extends GraphicsLab
{
    ...
    {
        // draw below cubes as a wireframe
        GL11.glPolygonMode(GL11.GL_FRONT_AND_BACK, GL11.GL_LINE);
        ...
        // fill the cubes below this point
        ...
        GL11.glPushMatrix();
        {
	        ...
	        drawUnitCube(new Colour(238,154,0), Colour.CYAN,Colour.RED,Colour.RED,Colour.GREEN,Colour.GREEN);
        }
        GL11.glPopMatrix();
